...
const HistoryMoviesPage: FC<IMoviesPageProps> = ({ searchParams }) => {
    return (
        <section className={styles.moviesContainer}>
            <MoviesList getCustomMovies={moviesService.getMoviesByGenre} searchParams={searchParams} url={byGenre('36')} pageQuery={pageQuery}/>
        </section>
    );
};
